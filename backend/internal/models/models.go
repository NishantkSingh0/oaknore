...
type Project struct {
	...
	ClientContact   sql.NullString `db:"client_contact"    json:"client_contact,omitempty"`
	Name            string         `db:"name"              json:"name"`
	Quantity        int            `db:"quantity"          json:"quantity"`
	Dimensions      sql.NullString `db:"dimensions"        json:"dimensions,omitempty"`
	Specifications  sql.NullString `db:"specifications"    json:"specifications,omitempty"`
	MaterialDetails sql.NullString `db:"material_details"  json:"material_details,omitempty"`
	ColorDetails    sql.NullString `db:"color_details"     json:"color_details,omitempty"`
	Upholstery      sql.NullString `db:"upholstery"        json:"upholstery,omitempty"`
	Finish          sql.NullString `db:"finish"            json:"finish,omitempty"`
	DeliveryDate    *time.Time     `db:"delivery_date"     json:"delivery_date,omitempty"`
	DeliveryAddress sql.NullString `db:"delivery_address"  json:"delivery_address,omitempty"`
	Remarks         sql.NullString `db:"remarks"           json:"remarks,omitempty"`
	CoverImageURL   sql.NullString `db:"cover_image_url"   json:"cover_image_url,omitempty"`
	CADFilesURL     sql.NullString `db:"cad_files_url"     json:"cad_files_url,omitempty"`
	DrawingsURL     sql.NullString `db:"drawings_url"      json:"drawings_url,omitempty"`
	JobCardsURL     sql.NullString `db:"job_cards_url"     json:"job_cards_url,omitempty"`
	RenderFilesURL  sql.NullString `db:"render_files_url"  json:"render_files_url,omitempty"`
...
type ProjectRevision struct {
	...
	ClientRequestRef    sql.NullString  `db:"client_request_ref"    json:"client_request_ref,omitempty"`
...
type Issue struct {
	...
	CustomType     sql.NullString `db:"custom_type"      json:"custom_type,omitempty"`
	Title          string         `db:"title"            json:"title"`
	...
	ReviewNotes    sql.NullString `db:"review_notes"     json:"review_notes,omitempty"`
	ResolvedBy     *uuid.UUID     `db:"resolved_by"      json:"resolved_by,omitempty"`
	ResolvedAt     *time.Time     `db:"resolved_at"      json:"resolved_at,omitempty"`
	ResolutionNote sql.NullString `db:"resolution_note"  json:"resolution_note,omitempty"`
	CreatedAt      time.Time      `db:"created_at"       json:"created_at"`
	UpdatedAt      time.Time      `db:"updated_at"       json:"updated_at"`
